...
using QH = COMP302.Decimator.QuadricHelper;
...
namespace COMP302.Decimator
{
    ...
    public class EdgeCollapse
    {
        ...
        public float GetExtraWeight()
        {
            ...
            if (this._param.UsedProperty.HasFlag(VertexProperty.UV0))
            {
                var setting = this._param.GetPropertySetting(VertexProperty.UV0);
                int size = this.CountDifference(lst, setting, (value) => {
